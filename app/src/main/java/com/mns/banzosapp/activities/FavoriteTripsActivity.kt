...
import kotlinx.android.synthetic.main.activity_favorite_trips.*
...
class FavoriteTripsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun init() {
        tv_title.text = "My Favorite Trips"
        iv_back.setOnClickListener(this)

        rv_favTrips.setHasFixedSize(true)
        rv_favTrips.layoutManager = LinearLayoutManager(this)

        rv_favTrips.adapter = FavTripListAdapter(this, "fav_trip",
